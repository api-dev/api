...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $app->request->baseUrl; ?>/css/generator/main.css" />
        ...
        <script src="<?php echo $app->request->baseUrl; ?>/js/angularjs/angular-1.2.9/angular-dragdrop.js"></script>
    ...
    <body class="{{bodyClass}}" ng-controller="bodyStyleCtrl">
        <div class="panel">
            ...
            <div class="user-info">
                ...
                <span ng-click="userDisplay = !userDisplay"><?php echo $user->surname.' '.substr($user->name, 0, 2).'.'.substr($user->secondname, 0, 2).'.';?></span>
