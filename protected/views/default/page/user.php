<h1>API пользователи</h1>
    ...
    <div class="item">
        ...
        <div class="text">
            ...
            <p>Параметры:
            <ul>
                <li><span class="param">action</span> - действие с передаваемым пользователем. <i><b>photo</b> - добавление/редактирование фотографии пользователя(в разработке)</i>, во всех остальных случаях добавление/редактирование </li>
